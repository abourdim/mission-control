...
//
// Last updated: 2026-04-05 18:32 (non-blocking showArrow/showIcon)
// =====================================
...
bluetooth.onBluetoothConnected(function () {
    ...
    basic.showIcon(IconNames.Yes, 0)     // ✓ tick (non-blocking)
    basic.pause(400)
    basic.clearScreen()
...
bluetooth.onBluetoothDisconnected(function () {
    ...
    basic.showIcon(IconNames.No, 0)      // ✗ cross (non-blocking)
...
function showDirectionArrow(dir: string, pressed: string) {
    ...
    // Passing interval=0 makes showArrow/showIcon non-blocking so
    // rapid D-pad presses don't queue up behind a 400ms animation.
    if (pressed != "1") {
        basic.showIcon(IconNames.Square, 0) // stop/neutral
        return
    }

    if (dir == "UP") basic.showArrow(ArrowNames.North, 0)
    else if (dir == "DOWN") basic.showArrow(ArrowNames.South, 0)
    else if (dir == "LEFT") basic.showArrow(ArrowNames.West, 0)
    else if (dir == "RIGHT") basic.showArrow(ArrowNames.East, 0)
    else basic.showIcon(IconNames.SmallSquare, 0)
}
