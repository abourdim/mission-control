# Customization checklist — Mini Mission Control
...
- [ ] `etsy-package/tools/generate-video.mjs` — ffmpeg-based generator
   ...
   `Mini Mission Control` / `Call • Command • Control` substitutions don't fit your design.
...
- [ ] (Optional) `gh api -X POST "repos/abourdim/mission-control/pages" -f 'source[branch]=main' -f 'source[path]=/'` — enable GitHub Pages so the live demo URL in the listing actually works
