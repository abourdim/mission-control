# Mini Mission Control → Etsy 1-Minute Demo Playbook
...
- [ ] two devices (laptop + phone) powered on, showing the **X** icon *(if not → re-flash `makecode.ts`)*
...
**Title (140 chars max):**
```
Mini Mission Control — BLE Control Panel for Teachers & Kids · Sensors · Servos · Live Graph · 3D Models · No Install · Chrome / Edge
```

**160-char short description:**
```
Browser-based BLE control panel for the two devices (laptop + phone). Sensors, servos, live graphs, 3D models, and a GamePad — all from Chrome. No install, no account.
```
