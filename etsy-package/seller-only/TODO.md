...
> 🧪 **Live demo**: <https://abourdim.github.io/mission-control/>
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `MissionControl-v1.0.0.zip` actually contains?
...
- [x] ~~Host a live demo on GitHub Pages~~ — done. Live at
      <https://abourdim.github.io/mission-control/>. Already in the
      listing description.
