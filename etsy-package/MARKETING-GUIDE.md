# Marketing Asset Guide — Mini Mission Control
...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Logs panel with "Live from micro:bit" call-out. |
...
| `graph-record.gif` | Logs panel with Simulate running — live waveform | Etsy listing slot (secondary) · YouTube community post |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Link Two Devices in 3 Seconds" + 5 steps. |
...
**Where:** Paste into `mission-control/index.html` or the hosted live-demo
page (`abourdim.github.io/mission-control`). Nothing else to do.
...
Output: `output/shared/buyers/MissionControl-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/mission-control-companion`
- Listed in the Etsy description: "MakeCode extension published — search mission-control-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Logs panel, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Logs panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/mission-control/#tab=board3d"
