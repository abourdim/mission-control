...
const I18N = {
  en: { tagline: 'Call. Command. Control.', role: 'Mini Mission Control · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · Mini Mission Control', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · Mini Mission Control', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
