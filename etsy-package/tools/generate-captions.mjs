...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم WebRTC · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, D-pad, fonctionnalités. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique WebRTC · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  teacher: {
    ...
    socialCaptions: [
      ...
      `One Etsy download. Zero IT tickets. Thirty students graphing real D-pad data.`,
    ],
    pinCaptions: [
  ...
  kid: {
    ...
    subtitles: [
      `Sensors, D-pad, 3D models. No install. No account.`,
      `Works offline after the first open.`,
      `Draw on the LEDs. Hear the buzzer. Tilt the 3D model.`,
      `3 panels of things to try. Your parents won't understand most of them.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `WebRTC graph · Three.js models · makecode.ts source included`,
