...
RULES_BY_LANG.en = [
  ...
  },
  {
    ...
    answer: `The Logs panel records live sensor data and exports CSV — one row per sample, ready for Excel / Sheets / Python. You can also load back a saved CSV and replay it.`,
  },
  {
    id: 'D-pad-motors',
