...
All Etsy-release assets for **Mini Mission Control**: the ZIP builder, the
...
Produces `etsy-package/MissionControl-v1.0.0.zip` with the app
...
├── MissionControl-v1.0.0/         📦 Build staging dir
├── MissionControl-v1.0.0.zip      📦 Final buyer ZIP
│
